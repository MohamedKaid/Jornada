...
struct FinancialTipsPage: View {
    ...
    var body: some View {
        ...
        ZStack{
            ...
            Color("JornadaYellow").ignoresSafeArea(edges: .top)
            ScrollView {
                VStack{
                    ...
                    if isPortuguese == true {
                        ...
                        Toggle("Toggle Here for English", isOn: $isPortuguese)
                            .font(.custom("GROBOLD", size: 19))
                            .padding(15)
                        ...
                        Toggle("Alternar aqui para português", isOn: $isPortuguese)
                            .font(.custom("GROBOLD", size: 19))
                            .padding(30)
